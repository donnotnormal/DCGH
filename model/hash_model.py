...
# 定义两层全连接网络
class TwoLayerHashNet(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        super(TwoLayerHashNet, self).__init__()
...
class DCGH(nn.Module):

    def __init__(self, 
                outputDim=64, 
                clipPath="/home/cgh/DCGH-main/ViT-B-32.pt",
                writer=None, 
                saveDir="/home/cgh/DCGH-main/result/log",
                logger: logging.Logger=None, 
                is_train=True):
        super(DCGH, self).__init__()
    ...
    def clip_encode_text(self,text):
        ...
        text_embed = self.clip.encode_text(text) #512
