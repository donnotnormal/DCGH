...
if __name__ == "__main__":
    ...
    parser.add_argument("--coco-dir", default="/home/cgh/archive/coco2017", type=str, help="the coco dataset dir")
    ...
    captions = {"caption": np.array(captionList, dtype=object)}
    categorys = {"category": categoryList}

    scio.savemat("/home/cgh/DSPH-main/dataset/coco/index.mat", indexs)
    scio.savemat("/home/cgh/DSPH-main/dataset/coco/caption.mat", captions)
    scio.savemat("/home/cgh/DSPH-main/dataset/coco/label.mat", categorys)
