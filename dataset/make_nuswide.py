...
root_dir = "/home/cgh/archive/NUS-WIDE"
...
imagePath = os.path.join("/home/cgh/archive/NUS-WIDE/Flickr")
...
with open("/home/cgh/archive/NUS-WIDE/Groundtruth/used_label.txt", encoding='utf-8') as f:
...
not_used_id = []
with open("/home/cgh/archive/NUS-WIDE/Groundtruth/not-used-id.txt", encoding='utf-8') as f:
...
scio.savemat('/home/cgh/DSPH-main/dataset/nuswide/index.mat', indexs)
# scio.savemat("caption.mat", captions)
scio.savemat('/home/cgh/DSPH-main/dataset/nuswide/label.mat', labels)


captions = [item + "\n" for item in captions["caption"]]

with open('/home/cgh/DSPH-main/dataset/nuswide/caption.txt', "w", encoding='utf-8') as f:
