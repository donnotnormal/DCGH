...
def get_args():
    ...
    parser.add_argument("--save-dir", type=str, default="/home/cgh/DCGH-main/result/64-bit")
    parser.add_argument("--clip-path", type=str, default="/home/cgh/DCGH-main/ViT-B-32.pt", help="pretrained clip path.")
    parser.add_argument("--pretrained", type=str, default="")
    parser.add_argument("--dataset", type=str, default="flckr25k", help="choise from [coco, mirflckr25k, nuswide]")
...
sheet = xlrd.open_workbook('/home/cgh/DCGH-main/utils/codetable.xlsx').sheet_by_index(0)
